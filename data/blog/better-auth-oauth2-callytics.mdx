...
- ✅ Added `token_type: "bearer"` to indicate the authentication scheme
- ✅ Added `expires_in: 1800` (30 minutes in seconds) for proper expiration tracking
- ✅ Added `Cache-Control: no-store` header to prevent token caching (security best practice)
